public class TestCellCompare {
    public static void main(String[] args) {
        ...
        // Test con objetos no comparables (comentado si no se utiliza la restricción Comparable)
        Cell<Object> cell11 = new Cell<>(new Object());
        Cell<Object> cell12 = new Cell<>(new Object());
        System.out.println("Comparando Object: " + cell11.compareTo(cell12));  // Debería lanzar UnsupportedOperationException
    }
}
